    ...
    >
      ...
      {screen === 'quiz' && level && question && (
        <>
          ...
          <header className="vn-sysline" aria-label="システム">
            <span className="vn-sysline__q">
              SCENE {qIndex + 1} / {QUESTIONS_PER_RUN}
            </span>
            <span className="vn-sysline__divider" aria-hidden>
              │
            </span>
            <span className="vn-sysline__chapter">{level.title}</span>
            <span className="vn-sysline__spacer" />
            <button type="button" className="vn-sysline__back" onClick={resetToTitle}>
              TITLE
            </button>
          </header>
          ...
          <div className="vn-adv-stack">
            ...
            <div className="vn-adv-anchor">
              <div
                className={`vn-adv-window ${advClickable ? 'vn-adv-window--clickable' : ''}`}
              ...
              >
                <div className="vn-adv-window__chrome">
                  <span className="vn-adv-window__corner vn-adv-window__corner--tl" />
                  <span className="vn-adv-window__corner vn-adv-window__corner--tr" />
                  <span className="vn-adv-window__corner vn-adv-window__corner--bl" />
                  <span className="vn-adv-window__corner vn-adv-window__corner--br" />
                </div>
                ...
                <div className="vn-adv-window__body">
                  ...
                  {advClickable ? (
                    <div className="vn-next-pointer" aria-hidden>
                      <span className="vn-next-pointer__glyph">▼</span>
                      <span className="vn-next-pointer__lbl">
                        {quizPhase === 'score'
